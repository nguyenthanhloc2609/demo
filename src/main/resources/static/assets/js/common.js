...
function saveDefautProject(data) {
    localStorage.setItem('project_id', data.id);
    localStorage.setItem('project_name', data.projectName);
}

function getDefautProject() {
    var selectedItem = localStorage.getItem('project_id');
    var selectedName = localStorage.getItem('project_name');

    return {id: selectedItem, projectName: selectedName};
}
